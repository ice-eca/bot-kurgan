...
def enter_district(message):
    ...
    bot.send_message(message.chat.id, 'Бесплатный мастер-классы по программированию в Кургане\U0001F381\n\nВ честь старта нового учебного IT-школа KIBERone проводит полезные мастер-классы. Совершенно бесплатно ребят научат программировать.\n\nМастер-класс будет проходить на базе игры Minecraft – ребята попробуют себя в роли начинающих айтишников  и запрограммируют своего персонажа.\nДлительность занятия – 60 минут.\nРодителям расскажут, как избавить свое чадо от игромании и научить компьютерной грамотности\n\nДля бронирования укажите удобный для вас адрес:\U0001F447' , reply_markup=markup)
